...
class TableTestCase(SimpleTestCase):
    ...
    def test_state_construction_and_state_deconstruction(self) -> None:
        ...
        table.sit('u1', 5)
        self.assertFalse(table.can_construct_state())
        table.rebuy_top_off_or_rat_hole('u0', 200)
        self.assertFalse(table.can_construct_state())
        table.rebuy_top_off_or_rat_hole('u1', 200)
        ...
        self.assertEqual(table.state.player_count, 2)
        table.rebuy_top_off_or_rat_hole('u2', 200)
        self.terminate(table.state)
        table.rebuy_top_off_or_rat_hole('u3', 200)
        table.destroy_state()
        ...
        table.rebuy_top_off_or_rat_hole('u1', 200)
        table.rebuy_top_off_or_rat_hole('u2', 100)
        table.rebuy_top_off_or_rat_hole('u2', 200)
        ...
        table.rebuy_top_off_or_rat_hole('u0', 100)
        u0_indices.add(table.get_seat('u0').player_index)
        u2_indices.add(table.get_seat('u2').player_index)
    ...
    def test_rebuying_or_topping_off(self) -> None:
        ...
        self.assertFalse(table.can_rebuy_top_off_or_rat_hole('u0', 200))
        table.sit('u0', 5)
        self.assertFalse(table.can_rebuy_top_off_or_rat_hole('u0', 40))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 100))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 150))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 200))
        self.assertFalse(table.can_rebuy_top_off_or_rat_hole('u0', 400))
        table.rebuy_top_off_or_rat_hole('u0', 150)
        self.assertFalse(table.can_rebuy_top_off_or_rat_hole('u0', 40))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 100))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 150))
        self.assertTrue(table.can_rebuy_top_off_or_rat_hole('u0', 200))
